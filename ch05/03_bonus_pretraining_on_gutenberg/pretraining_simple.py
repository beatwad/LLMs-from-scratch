...
import tiktoken
import torch
from previous_chapters import GPTModel, calc_loss_batch, create_dataloader_v1, evaluate_model, generate_and_print_sample, plot_losses
            ...
            for index, file_path in enumerate(all_files, 1):
                ...
                for input_batch, target_batch in train_loader:
                    ...
                    if global_step % eval_freq == 0:
                        ...
                        print(f"Ep {epoch+1} (Step {global_step}): " f"Train loss {train_loss:.3f}, Val loss {val_loss:.3f}")
