...
def calc_loss_loader(data_loader, model, device, num_batches=None):
    ...
    for i, (text_batch, target_batch) in enumerate(data_loader):
        ...
        loss = calc_loss_batch(text_batch, target_batch, model, device)
...
def generate_and_print_sample(model, tokenizer, device, start_context):
    ...
    with torch.no_grad():
        token_ids = generate(model=model, idx=encoded, max_new_tokens=50, context_size=context_size, eos_id=50256)
